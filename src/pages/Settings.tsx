        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-slate-900">Components</h3>
                <button
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex justify-end space-x-3">
                      ...
                      <button
                        ...
                        className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-stone-600 hover:bg-stone-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-stone-500"
                      >
                        Save
                      </button>
                    </div>
              ...
              <div className="mt-4">
                {loading ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-slate-500">No components yet. Add one to get started.</p>
                  </div>
                ) : (
          ...
          <div className="bg-white shadow rounded-lg mt-6">
            <div className="px-4 py-5 sm:p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  <h3 className="text-lg font-medium text-slate-900">Test Run Templates</h3>
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-stone-600 hover:bg-stone-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-stone-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Add Template
                </button>
              </div>
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex space-x-2">
                          <button
                            ...
                            className="px-2 py-1 text-xs border border-slate-300 rounded-md shadow-sm text-slate-700 bg-white hover:bg-slate-50"
                          >
                            Select All
                          </button>
                          <button
                          ...
                          <table className="min-w-full divide-y divide-slate-200">
                            ...
                            <tbody className="bg-white divide-y divide-slate-200">
                              {testCases.map(testCase => (
                                <tr
                                  key={testCase.id}
                                  className={selectedTestCases.has(testCase.id) ? 'bg-stone-50' : 'hover:bg-slate-50'}
                                >
                                  <td className="px-3 py-2 whitespace-nowrap">
                                    <input
                                      ...
                                      className="h-4 w-4 text-blue-600 focus:ring-stone-500 border-slate-300 rounded"
                                    />
                                  </td>
              ...
              <div className="mt-4">
                {loading ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-slate-500">No templates yet. Add one to get started.</p>
                  </div>
                ) : (
                  <table className="min-w-full divide-y divide-slate-200">
                    <thead className="bg-slate-50">
